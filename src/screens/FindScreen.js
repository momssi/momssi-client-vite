    ...
    <div class="max-w-md lg:max-w-4xl mx-auto px-4 py-6 flex flex-col items-center justify-center" style="min-height: 70vh;">
      ...
      <div class="max-w-md lg:max-w-4xl mx-auto px-0 pt-6 pb-6">
        <div class="flex items-center justify-between">
          <a href="#word" class="bg-white text-gray-600 border border-gray-200 rounded-xl px-6 py-3 text-sm font-medium">이전</a>
          <a href="#apply" class="flex-1 ml-4 bg-brown-700 text-white rounded-xl py-3 px-4 text-center text-sm font-medium">다음</a>
        </div>
      </div>
    </div>
  </div>
